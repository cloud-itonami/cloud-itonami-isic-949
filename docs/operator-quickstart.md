# Operator Quickstart — cloud-itonami-isic-949

Shortest path from clone to a verified local dry-run for **ISIC 949** (`cloud-itonami-isic-949`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-949.git
cd cloud-itonami-isic-949
```
...
- Likely source path: `civicmembershiporg.governor.cljc`
